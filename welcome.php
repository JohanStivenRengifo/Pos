...
<body class="bg-gray-50">
    ...
    <div class="flex">
        ...
        <main class="flex-1 p-8">
            ...
            <div class="mb-8 p-8 rounded-2xl bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg animate-fade-up">
                <div class="flex justify-between items-center">
                    <div>
                        <h1 class="text-4xl font-extrabold mb-2">
                            ¡Bienvenido a <span class="text-yellow-300">VendEasy</span> - Sistema Contable!
                        </h1>
                        <p class="text-gray-200 text-lg">
                            Panel de control de <span class="font-semibold">
                                <?= htmlspecialchars($empresa_info['nombre_empresa'] ?? 'su empresa') ?>
                            </span>
                        </p>
                    ...
                    <div class="hidden md:flex items-center justify-center w-24 h-24 bg-white/20 rounded-full shadow-lg animate-pulse">
...
<div class="mb-8 p-6 bg-gradient-to-r from-blue-500 to-indigo-600 border border-blue-300 rounded-2xl shadow-lg text-white animate-fade-up" data-aos="fade-up" data-aos-delay="200">
    <div class="flex items-center">
        <div class="flex-shrink-0 p-3 bg-white/20 rounded-full shadow-md">
        ...
        <div class="ml-4 flex-1">
            <div class="flex items-center justify-between">
                ...
                <a href="https://portal.johanrengifo.cloud" target="_blank" class="inline-flex items-center px-5 py-2.5 bg-yellow-400 hover:bg-yellow-500 text-gray-900 text-sm font-medium rounded-xl transition-transform transform hover:scale-105 shadow-md">
                    Visitar Portal
