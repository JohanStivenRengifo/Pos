...
// Función para obtener datos de ventas por método de pago
...
$ventasNetasPorMes = getVentasNetasPorMes($user_id);
$ventasPorMetodoPago = getVentasPorMetodoPago($user_id);
$ultimasVentas = getUltimasVentas($user_id);
...
<body>
    ...
    <script>
    // Gráfico de Ventas Netas por Mes
