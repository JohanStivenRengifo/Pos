...
// Obtener datos de sesión o cookies
...
// Solo consultar la base de datos si tenemos user_id y pdo
if ($user_id && isset($pdo)) {
    try {
        ...
        // Si no hay email en la sesión, pero lo tenemos de la base de datos
        if (empty($email) && !empty($empresa_info['email'])) {
...
// Asegurar que tenemos valores por defecto para evitar errores
$empresa_info['user_name'] = $empresa_info['user_name'] ?? '';
$email = $email ?: 'usuario@example.com'; // valor por defecto si está vacío
?>
